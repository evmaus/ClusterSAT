...
constexpr char sat_testdata_directory[] = "src/tribblesat/sat/testdata/sat/*.cnf";
constexpr char unsat_testdata_directory[] = "src/tribblesat/sat/testdata/unsat/*.cnf";
